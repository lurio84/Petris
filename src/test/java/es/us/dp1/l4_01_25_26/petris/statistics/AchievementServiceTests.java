...
//         Achievement achievement = achievementService.getAchievementByName("name1"); 
//         assertThat(achievement).isNotNull();
//         assertThat(achievementService.getAchievementByName("name1").getName()).isEqualTo("name1");
//     }
//     @Test //404
...
//         invalidAchievement.setThreshold(2.0);
//         invalidAchievement.setMetric(RuleType.VICTORIES);
