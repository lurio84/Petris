...
import es.us.dp1.lx_xy_24_25.your_game_name.statistic.AchievementRestController;
import es.us.dp1.lx_xy_24_25.your_game_name.statistic.AchievementService;
...
class AchievementRestControllerTests { 
    ...
    // @WithMockUser(username = "player", roles = {"PLAYER"})
    // void shouldNotUpdateAchievementBadRequest() throws Exception {
    ...
    // @Test // (FORBIDDEN) 403
    // @WithMockUser(username = "123" ,roles = {"123"})    
    // void shouldNotUpdateAchievementForbidden() throws Exception {
    ...
    // @Test // (FORBIDDEN) 403
    // @WithMockUser(username = "123" ,roles = {"123"})    
    // void shouldNotDeleteAchievementForbidden() throws Exception {
